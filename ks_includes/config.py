...
class KlipperScreenConfig:
        ...
        for section in config:
            ...
            if section == 'main':
                bools = (
                    ...
                    'show_heater_power', "show_scroll_steppers", "auto_open_extrude", "encoder_support"
                )
                strs = (
                ...
                numbers = (
                    ...
                    'encoder_pin_a', 'encoder_pin_b', 'encoder_pin_button', 'encoder_hold_time',
                )
    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options = [
            ...
            # {"encoder_support": {"section": "main", "name": _("Encoder Support"), "type": "binary",
                             # "tooltip": _("Enable rotary encoder support"),
